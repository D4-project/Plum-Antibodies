...
Run the checker before committing rule changes. It validates every YAML rule, including required short names, unique UUID values, versions, query syntax, references, and normalized tags.
